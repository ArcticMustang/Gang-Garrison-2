...
global.console_commandMap = ds_map_create()//All console commands are here, with the name being the key to the to-be executed string.
global.console_documentationMap = ds_map_create()//See above, only this gets called when a user enters "help something".
